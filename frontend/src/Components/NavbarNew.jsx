          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <span className="font-bold text-gray-900 text-base tracking-tight">BlogCraft AI</span>
              </div>
            </div>
            ...
            <div className="hidden lg:flex items-center space-x-8">
              ...
              {/* CTA Button */}
              <div
                className="px-5 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-sm transition-all duration-200 shadow-sm cursor-pointer"
                onClick={() => router.push('/Contact-us')}
              >
                Get Started
              </div>
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-2 rounded-lg border border-gray-200 text-gray-700 hover:border-indigo-400 hover:text-indigo-600 text-sm font-semibold transition-all duration-200 cursor-pointer bg-white"
              >
                Login
          ...
          >
            <div className="py-4 space-y-2 border-t border-gray-100 mt-4">
              ...
              <div className="px-4 pt-4">
                <div
                  className="block w-full text-center bg-indigo-600 hover:bg-indigo-500 text-white px-6 py-3 rounded-lg font-semibold text-sm transition-all duration-200 cursor-pointer"
              ...
              <div className="px-4 pt-2">
                <button
                  ...
                  className="flex items-center justify-center gap-2 w-full rounded-lg border border-gray-200 text-gray-700 hover:border-indigo-400 hover:text-indigo-600 text-sm font-semibold px-6 py-3 transition-all bg-white"
                >
                  Login
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
